...
const ReportEndorse = () => {
    ...
    const [endorsetype, setEndorsetype] = useState();
        ...
        <div className="container" style={{ paddingTop: "30px", paddingBottom: "30px" }}>
            <div className="row justify-content-center">
                <div className="col-lg-10">
                    <form>
                        <h2 className="text-center" style={{ marginBottom: "30px" }}>รายงานบันทึกสลักหลัง</h2>
                        ...
                        <div className="row my-3">
                            <label class="col-sm-2 col-form-label" htmlFor="endorsetype">
                                ประเภทสลักหลัง
                            </label>

                            <div class="form-check col-2">
                                <input class="form-check-input" type="radio" name="endorseradio" id="endorseradio1" defaultChecked onChange={(e) => setEndorsetype('1')} />
                                <label class="form-check-label" for="endorseradio1">
                                    ALL
                                </label>
                            </div>
                            <div class="form-check col-2">
                                <input class="form-check-input" type="radio" name="endorseradio" id="endorseradio2" onChange={(e) => setEndorsetype('2')} />
                                <label class="form-check-label" for="endorseradio2">
                                    ไม่กระทบค่าเบี้ย
                                </label>
                            </div>
                            <div class="form-check col-2">
                                <input class="form-check-input" type="radio" name="endorseradio" id="endorseradio3" onChange={(e) => setEndorsetype('3')} />
                                <label class="form-check-label" for="endorseradio3">
                                    เบี้ยเพิ่ม
                                </label>
                            </div>
                            <div class="form-check col-2">
                                <input class="form-check-input" type="radio" name="endorseradio" id="endorseradio4" onChange={(e) => setEndorsetype('4')} />
                                <label class="form-check-label" for="endorseradio4">
                                    เบี้ยลด
                                </label>
                            </div>
                            <div class="form-check col-2">
                                <input class="form-check-input" type="radio" name="endorseradio" id="endorseradio5" onChange={(e) => setEndorsetype('5')} />
                                <label class="form-check-label" for="endorseradio5">
                                    WD
                                </label>
                            </div>
                            <div class="form-check col-2">
                                <input class="form-check-input" type="radio" name="endorseradio" id="endorseradio6" onChange={(e) => setEndorsetype('6')} />
                                <label class="form-check-label" for="endorseradio6">
                                    CS
                                </label>
                            </div>
                        </div>
