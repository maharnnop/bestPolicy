        ...
        <div className="container" style={{paddingTop: "30px", paddingBottom: "30px" }}>
            <div className="row justify-content-center">
                <div className="col-lg-10">
                    <form>
                        <h2 className="text-center" style={{marginBottom:"30px"}}>รายงานที่ลูกค้าจ่ายเงินที่ประกัน</h2>
...
<div className="row mb-3">
                     ...
                     <div className="row">
                            <div className="col-2">
                                <label htmlFor="Date Select" className="form-label">dfrprederno </label>
                            </div>
                            <div className="col-4">
...
export default ReportฺARAPDirect;
