...
namespace BestPolicyReport.Controllers
{
    ...
    public class ArApController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<PremInReportResult>?>> GetPremInOpenItemReportJson(ArApReportInput data)
        {
        ...
        public async Task<IActionResult?> GetPremInOpenItemReportExcel(ArApReportInput data)
        {
            ...
            foreach (var i in result)
            {
                ...
                worksheet.Cell(row, col++).Value = i.PolicyStatus;
        ...
        public async Task<ActionResult<List<PremOutCommInOvInReportResult>?>> GetPremOutOpenItemReportJson(ArApReportInput data)
        {
            var result = await _arApService.GetPremOutOpenItemReportJson(data);
            if (result == null)
            {
                return Ok(new List<PremOutCommInOvInReportResult>());
            }
            return Ok(result);
        }
        ...
        public async Task<ActionResult<List<PremOutCommInOvInReportResult>?>> GetPremOutClearingReportJson(ArApReportInput data)
        {
        ...
        public async Task<ActionResult<List<PremOutCommInOvInReportResult>?>> GetPremOutOutstandingReportJson(ArApReportInput data)
        {
        ...
        public async Task<ActionResult<List<PremOutCommInOvInReportResult>?>> GetCommInOvInOpenItemReportJson(ArApReportInput data)
        {
        ...
        public async Task<ActionResult<List<PremOutCommInOvInReportResult>?>> GetCommInOvInClearingReportJson(ArApReportInput data)
        {
        ...
        public async Task<ActionResult<List<PremOutCommInOvInReportResult>?>> GetCommInOvInOutstandingReportJson(ArApReportInput data)
        {
